                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('web_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="web_name" id="web_name" value="{{ old('web_name', $setting->web_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="address" id="address">{{ old('address', $setting->address) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('tag_line') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tag_line" id="tag_line" value="{{ old('tag_line', $setting->tag_line) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('open_hours') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="open_hours" id="open_hours" value="{{ old('open_hours', $setting->open_hours) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('about_web') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="about_web" id="about_web">{!! old('about_web', $setting->about_web) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('linkind') ? 'has-error' : '' }}">
                            <label for="linkind">Alamat Linkind</label>
                            <input class="form-control" type="text" name="linkind" id="linkind" value="{{ old('linkind', $setting->linkind) }}">
                        ...
                        <div class="form-group {{ $errors->has('paragraf_tag_line') ? 'has-error' : '' }}">
                            <label for="paragraf_tag_line">Motto Paragraf</label>
                            <textarea class="form-control" name="paragraf_tag_line" id="paragraf_tag_line">{{ old('paragraf_tag_line', $setting->paragraf_tag_line) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('cover_image') ? 'has-error' : '' }}">
                            <label for="cover_image">Gambar banner</label>
