            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($setting->cover_image)
                                            <a href="{{ $setting->cover_image->getUrl() }}" target="_blank" style="display: inline-block">
                                                <img src="{{ $setting->cover_image->getUrl('thumb') }}">
                                            </a>
                                        @endif
                                    </td>
                                </tr>
                        ...
                        <div class="form-group">
                            <a class="btn btn-warning" href="{{ route('admin.settings.edit', $setting->id) }}">
                               Ubah Pengaturan 
                            </a>
                        </div>
                    </div>
